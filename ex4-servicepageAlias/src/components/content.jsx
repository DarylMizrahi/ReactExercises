        ...
        return (
            <div className="BoxContent">{this.props.children}
                <div className="Content1">
                    ...
                    <p className="ContentText">Our vision is simple. We want to create websites and applications with both <br />
        high quality design and easy-to-access content. The finished product will be <br />
